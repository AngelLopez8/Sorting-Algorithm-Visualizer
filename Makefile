...
ALGO_FILES = $(ALGO_SRC_DIR)SortingAlgorithm.cpp $(ALGO_SRC_DIR)SelectionSort.cpp $(ALGO_SRC_DIR)BubbleSort.cpp $(ALGO_SRC_DIR)InsertionSort.cpp $(ALGO_SRC_DIR)MergeSort.cpp $(ALGO_SRC_DIR)HeapSort.cpp $(ALGO_SRC_DIR)QuickSort.cpp
ALGO_OBJ = SortingAlgorithm.o SelectionSort.o BubbleSort.o InsertionSort.o MergeSort.o HeapSort.o QuickSort.o
